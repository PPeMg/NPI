namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /**************************************************************/
        /// <summary>
        /// Pen used for drawing bones when the position is incorrect:
        /// </summary>
        private readonly Pen badPositionPen = new Pen(Brushes.Red, 6);

        /// <summary>
        /// Pen used for drawing bones when the position is correct:
        /// </summary>
        private readonly Pen correctPositionPen = new Pen(Brushes.Green, 6);
        ...
        {
            /////////////////////////////////////////////////////////
            //Variables añadidas para controlar mensajes en pantalla:
            /////////////////////////////////////////////////////////
            string coordenadas = "";
            ...
            using (DrawingContext dc = this.drawingGroup.Open())
            {
                ...
                //Declaramos las articulaciones que usaremos:
                Joint leftAnkle, leftKnee, leftHip;
            ...
            LeftLegCoords.Text = coordenadas;
        }
        ...
        /// <param name="jointType0">joint to start drawing from</param>
        /// <param name="jointType1">joint to end drawing at</param>
        private void DrawBone2(Skeleton skeleton, DrawingContext drawingContext, JointType jointType0, JointType jointType1, Pen specialPen)
        {
            Joint joint0 = skeleton.Joints[jointType0];
            Joint joint1 = skeleton.Joints[jointType1];
